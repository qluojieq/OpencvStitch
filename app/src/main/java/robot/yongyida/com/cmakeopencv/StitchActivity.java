    ...
    public Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            switch (message.what){
                ...
                case 01:
                    if(message.arg1==1){
                        Toast.makeText(StitchActivity.this,"成功啦"+message.obj,Toast.LENGTH_LONG).show();
                    }else {
                        Toast.makeText(StitchActivity.this,"差一点点，加油！"+message.obj,Toast.LENGTH_LONG).show();
                    }
                    break;
            }
